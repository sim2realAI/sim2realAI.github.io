...
* Which simulator, given the parameterisation it uses (*e.g.* [generalised or maximal coordinates](/assets/img/GeneralisedVsMaximal.jpg) [and](https://www.cc.gatech.edu/classes/AY2014/cs7496_fall/slides/Lagrangian.pdf)), might be more fitting to a given task and which is the fastest?
